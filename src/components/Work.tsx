            ...
            <div className='sm:px-[32px] xl:[220px] px-[20px] sm:h-[75%]  bg-[#043873] relative'>
                <div className="flex justify-center relative ">
                    <Image
                        ...
                        width={320}
                        height={100}
                        className="absolute sm:right-[20px] right-[-5px] sm:w-[18vw] w-[32vw] sm:-top-[9.2vw] -top-[15vw] z-0"
                    />
                </div>
                    ...
                    <div className='flex flex-col sm:text-center'>
                        ...
                        <div className="relative">
                            <Image
                                ...
                                width={320}
                                height={100}
                                className="absolute  sm:w-[24vw] w-[28vw] sm:left-[50vw] left-[40vw] -bottom-0 z-0"
                            />
                        </div>
                        ...
                        <div className='flex sm:justify-center sm:mb-0 mb-[4vw]'>
                            <button className='flex items-center mt-[2.6vw] gap-2 bg-[#4F9CF9] px-[2.5vw] py-[1.6vw] sm:text-[1.1vw] text-[3vw] text-white sm:px-[2.2vw] sm:py-[1.2vw] sm:rounded-[0.5vw] rounded-sm'>Try Taskey <span> <FaArrowRight className='font-[100] sm:text-[1vw] text-[3vw]' /></span></button>
                        </div>
                    </div>
