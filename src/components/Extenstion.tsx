        ...
        <div className='sm:px-[32px] xl:[220px] px-[20px]  bg-[#043873]'>
            ...
            <div className='sm:flex  items-center md:h-[620px] sm:w-full md:py-0 py-16'>
                ...
                <div className='flex-1 sm:text-start text-center'>
                    <h1 className='text-white text-[10vw] sm:text-[50px] lg:text-[60px] font-bold sm:leading-[64px]'>Use as <span className="relative inline-block z-10">Extension</span></h1>
                        <div className="flex justify-center relative ">
                            <Image
                                ...
                                className="absolute lg:right-[120px] md:right-[40px] sm:right-[90px] right-0  sm:w-[24vw] w-[180px] sm:-bottom-3 -bottom-0 z-0"
                            />
                        </div>
